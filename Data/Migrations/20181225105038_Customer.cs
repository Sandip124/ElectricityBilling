        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sc_no = table.Column<string>(nullable: true),
                    ...
                    meter_no = table.Column<string>(nullable: true),
                    phase = table.Column<string>(nullable: true),
                    load = table.Column<int>(nullable: false),
                    due_amount = table.Column<float>(nullable: false),
                    initial_meter_reading = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
